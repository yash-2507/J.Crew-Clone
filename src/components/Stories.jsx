                ...
                <div className={styles.box6}>
                    <div className={styles.QnA}>
                        ...
                        <div className={styles.ques1}>
                            ...
                            <a>CK: We use technology to bring the ocean to people around the world, and to engage community members in our research—like showing students how to use a microscope or a drone, or making sure local youth have good surfboards to ride. We want to be supportive of ocean accessibility and exploration for all.</a>
                            </div>
                            <br></br>
                        <div className={styles.ques2}>
                            <p>What’s the MEGA Lab underwater camera?</p>
                            <a>CK: It’s a 24/7 live feed that monitors a small patch of reef in Hawaii. With minimal human disruption, we’ve been able to identify many types of reef animals already. Algae will grow on the camera, so we dive down and clean it off to nurture ongoing discovery.</a>
                        </div>
                        <br></br>
                        <div className={styles.ques3}>
                            <p>How can we all contribute to preserving the environment?</p>
                            <a>CK: The best way to support nature is simply to spend time in it. The physical, mental and spiritual benefits that the outdoors provide us are hard to articulate, so experiencing it firsthand is essential.</a>
                        </div>
                    </div>
                </div>
                ...
                <div className={styles.box7}>
                    <div className={styles.bo1}>
                        ...
                        <div className={styles.text1}>
                            “I pursued pro surfing while getting my PhD and my cofounder became a professor. MEGA Lab allows us to create new technology and provide it to those who need it.”
                        </div>
                    </div>
